...
bh = BasinHopping(temperature=0.01, random_seed=42, stepsize=2, nminima=50, plev=2, check_overlap=True, 
                  optimizer=LBFGS(maxstep=0.5, with_transport=True, with_canonical=True), opt_kwargs=opt_kwargs)
bh.run(wfn, nhop=1000)
