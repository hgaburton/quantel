...
# and i guess because im not consider 

conf1 = np.array([0,3,1,2]) 
a = 0 
b = 2 
c = 0 

drt  = get_drt(a,b,c) 
#upwards_connecting, downwards = coupling_table(single_solns, key)
#print("upwards connecting") 
#print(upwards_connecting)  
