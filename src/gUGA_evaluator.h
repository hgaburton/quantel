...
public: 
    ...
    double resolve_diag_threeish_body_matrix_element( const Configuration &config, const Eph Epq, const Eph Ers, const Eph Etv, const std::vector<Configuration> &basis) const ;  
