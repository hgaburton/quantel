...
public: 
    ...
    double resolve_diag_three_body( const Configuration &config, const Eph Epq, const Eph Ers, const Eph Etv, const std::vector<Configuration> &basis) const ;  
    double resolve_diag_four_body( const Configuration &config, const Eph Epq, const Eph Ers, const Eph Etv, const Eph Exy, const std::vector<Configuration> &basis) const ;  
