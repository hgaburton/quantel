...
\title{Understanding CASSCF multiple solutions}
...
These solutions has been shown to exist most often as non-zero index stationary points, \ie saddle points and maxima. \cite{Burton_2021}
Energy landscapes in electronic structure theory are mainly considered during minimization processes to target ground-state energies and their associated wave functions.
However, other higher stationary points exist on these landscapes and they might correspond to approximations of excited states or they can also be spurious unphysical solutions.
